...
''')
    ...
    def assert_audited(self, result):
        ...
        for required in ("test_source_audit.py", "test_deployment_state.py", "test_delivery.py", "test_queue_measurements.py", "test.sh", "test-dev-lanes.sh", "test-dispatch-tmux.sh", "test-past-agents-search.sh", "test-credits-onboarding.sh", "test-manager-listening.sh"):
