...
1. **Visual** — the panel shows the arming face: the listening pill's
   ...
   The green ack border (`holdAcknowledge`; every other gesture gets the
   same green through `acknowledge(.recognized)`) fires here too (ruled
   06 Aug) — at the press, not at
