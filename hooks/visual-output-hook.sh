...
text = (
    ...
    "message that opens with a bracket, \"[Tranquility Base read the user this "
    "summary of your previous turn, by voice: ...\", quoting exactly what they "
    "heard, and the words after the bracket are what they said in reply. Read "
    "\"go ahead\" against the quoted proposal.\n\n"
