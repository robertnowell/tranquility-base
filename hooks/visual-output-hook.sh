...
text = (
    ...
    "even when you asked several or none. Their spoken answer is typed into this "
    "session with a trailing bracket that starts \"[Tranquility Base spoke this "
    "summary of your previous turn\" and quotes exactly what they heard. The "
    "words BEFORE the bracket are the user's; the quote inside it is Tranquility "
    "Base's paraphrase of you, not the user's claim and not your words. Read "
    "\"go ahead\" against the quoted proposal, not against every question you "
    "asked, and never reply to the bracket itself.\n\n"
